...
function msg=check_fields(ds)
    ...
    delta=setdiff(fieldnames(ds),{'samples','dist','hypall','hyperplane','activation_pattern','distbytrial','fa','sa','a','trialnumbers'});
    % added hypall, hyperplane, dist, activation_pattern. Feb 2025, Ayaka Hachisuka
    if ~isempty(delta)
