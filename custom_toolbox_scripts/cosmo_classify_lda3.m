function [predicted,dist,hyperplane] = cosmo_classify_lda3(samples_train, targets_train, samples_test, opt)
...
function [predicted,dist]=test(model, samples_test)
    ...
    class_weight_onevec = diff(class_weight);

    m2plusm2 = sum(class_mean);
    class_offset_onevec = class_weight_onevec * m2plusm2' / 2;
